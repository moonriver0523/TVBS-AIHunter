...
- **閱讀狀態標籤**：`tag_unread.py` → `reading_status.json`——全部 1701 篇的 `B1`/`B2`/`B3`/`unread` 標記。已讀 160 篇（B1 50＋B2 50＋B3 60），未讀 1541 篇（<1200 字 359、1200–9000 字 1133、9000–20000 字 49、>20000 字 0）。**日後若需針對性補抽（特定題材/語域），從 `unread` 池取樣即可，不會重讀。**
