...
- [x] **B 步第七輪（2026-07-27 完成，Opus，未讀子類抽樣）**——40 篇（8 個從沒讀過的子類 × 5）→ [`style-corpus/analysis_B7.md`](style-corpus/analysis_B7.md)。28 條新招（U1–U28）＋7 條既有規則修正（M1–M7）＋4 組題材禁忌（G1–G4）。**三項硬修正**：①比喻死亡開關再切一刀，判準改為**「意外奪走／壽終儀典」**——訃聞與國葬稿的比喻是**開**的（鳥山明「生涯就像他筆下的悟空」、女王「靈柩如皇冠鑽石般耀眼」），只有意外／暴力奪走的死亡才關；②法庭稿吐槽開關看**案件有無死者**（川普性侵民事案「臉很腫」「過街老鼠」全開，柯克命案 OS 零吐槽、比喻全外包）；③外國選舉稿的**對台立場必須放在第一次提到當選人的那一句裡**（台灣錨點升級為位置硬規則）。最反直覺的發現是 **G3：宗教場所受襲稿的價值序是「古蹟＞人命」**（耶路撒冷稿零傷亡描述、奧德薩稿 2 死只用一句帶過）。**方法論**：B6 §8 三張處方全部實作——AI 產出前置偵測**完全成立**（攔截 4 篇，四個已知陽性回測全中、286 篇已讀零誤報）；題材標籤前驗**有效但不夠**（誤標率 43.8%→25%，但嚴格命中率降到 52.5%）。關鍵發現是**專屬「動作」詞遠比場景「名詞」準**：法庭／選舉／宗教誤標 0%，太空／教育／移民 40–60%。另發現**一檔多稿佔 12.5%**，是誤標的第二個來源（切分訊號：第二個 `網路標:` 區塊）。**⚠️ 精讀時發現語料裡的裸 token 密碼從未被清除，見上方資安節。** ⏳ **31 條建議尚未裁定入指南**（A級4／B級19／C級4／D級1／存檔3），見報告第六節。
