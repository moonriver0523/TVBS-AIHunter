...
- [ ] ⚠️ **剪接接點「夾畫面／裁切不乾淨」**（使用者 2026-07-25 回報，待修）：SB↔OS 交界仍有殘留非目標畫面/雜幀。SB 端已有 `sb_vad_trim.py` 音訊凹陷精裁，但**畫面切點未同步精裁**（只裁音訊接點，視訊仍照原 TC）。方向：視訊切點跟音訊 VAD 邊界對齊、接點加 1-2 幀緩衝或轉場遮蓋
