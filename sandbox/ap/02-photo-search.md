...
**開始前必讀**：[`../common/08-execution-efficiency.md`](../common/08-execution-efficiency.md)（瀏覽器操作、下載重試階梯、少截圖）。以下只列本站台特有條款。
...
- **預設只點列表 ⬇** 下載；**沒有 ⚠️ 就不要開詳情頁**（Photo 下載是同步立即完成，不像 Video 要排隊）。
