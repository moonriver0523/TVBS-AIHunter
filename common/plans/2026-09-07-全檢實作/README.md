...
| 序 | 計畫 | MASTER | 為什麼在這個位置 |
|---|---|---|---|
| 1 | [`01-T8-過期清理.md`](01-T8-過期清理.md) | T8 | 先把三處已知過期敘述清掉，後面兩份才不會搬到錯的內容 |
| 2 | [`02-A35-metrics補13g13h.md`](02-A35-metrics補13g13h.md) | A35 | 一行修；先補齊量測，後面 T13／A26 的驗收才看得到規則指紋 |
| 3 | [`03-R21-收斂prompt改指路.md`](03-R21-收斂prompt改指路.md) | R21 | 獨立、小；順手 |
| 4 | [`04-T13-prompt瘦身.md`](04-T13-prompt瘦身.md) | T13 | 先把 prompt 獨有的規則**搬進規則檔**，再瘦身 prompt |
| 5 | [`05-A26-五層合一.md`](05-A26-五層合一.md) | A26 刀4 擴充 | 最大的一刀；T13 搬進去的內容要一起合併，所以排最後 |
