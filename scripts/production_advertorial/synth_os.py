...
from sot_common import group_os_lines, load_script
...
def main():
    ...
    _, blocks, _ = load_script(args.script)
    groups_by_block = {b.get("id") or f"os{b['bar']}": group_os_lines(b["os"]) for b in blocks}
